...
// IMPORTANTE: Asume que PanelHistoria y PanelBuscador están en la ruta de clases
import UI.PanelHistoria;
import UI.PanelBuscador; // Descomentar si usas esta clase
...
public class VentanaPrincipal extends JFrame {
    ...
    private JPanel crearEncabezado() {
        ...
        ImageIcon icon = new ImageIcon("LogoUN.png");
        Image img = icon.getImage();
        Image imgEscalada = img.getScaledInstance(140, 70, Image.SCALE_SMOOTH);
        ImageIcon iconEscalado = new ImageIcon(imgEscalada);
        JLabel lblUn = new JLabel(iconEscalado);
        lblUn.setBounds(40, -10, 140, 100);
        top.add(lblUn);
    ...
    private JPanel crearMenuLateral() {
        ...
        menu.add(itemMenu("Inicio", false, e -> {
            cardLayout.show(panelContenido, "INICIO");
            lblRuta.setText("Está en: Inicio");
        }));
        menu.add(categoriaMenu("Apoyo Académico"));
        menu.add(subItemMenu("Mi Horario", e -> {
            cardLayout.show(panelContenido, "HORARIO");
            lblRuta.setText("Está en: Apoyo Académico >> Mi Horario");
        }));
        menu.add(categoriaMenu("Archivo"));
        menu.add(subItemMenu("Historia Académica", e -> {
            cardLayout.show(panelContenido, "HISTORIA");
            lblRuta.setText("Está en: Archivo >> Historia Académica");
        }));
        menu.add(subItemMenu("Datos Personales", e -> {
            cardLayout.show(panelContenido, "DATOS");
            lblRuta.setText("Está en: Archivo >> Datos Personales");
        }));
        menu.add(categoriaMenu("Buscador"));
        menu.add(subItemMenu("Catálogo de Cursos", e -> {
            cardLayout.show(panelContenido, "BUSCADOR");
            lblRuta.setText("Está en: Buscador >> Cursos");
        }));

        menu.add(Box.createVerticalStrut(20));
        JButton btnSalir = new JButton("Cerrar Sesión");
        btnSalir.setAlignmentX(Component.CENTER_ALIGNMENT);
        btnSalir.addActionListener(e -> { new VentanaLogin().setVisible(true);
        dispose(); }); // Asumiendo que VentanaLogin existe
        menu.add(btnSalir);
        return menu;
    }
    ...
    private JLabel categoriaMenu(String texto) {
        ...
        l.setFont(new Font("Verdana", Font.BOLD, 11));
        l.setForeground(COLOR_MENU_ITEM);
        l.setBorder(new EmptyBorder(5, 10, 2, 10));
    ...
    private JLabel itemMenu(String texto, boolean esSub, ActionListener action) {
        ...
        l.setBorder(new EmptyBorder(2, 15, 2, 10));
        l.setAlignmentX(Component.LEFT_ALIGNMENT);
    ...
    private JPanel crearPanelHistoria() {
        // Se instancia la clase PanelHistoria y se llama a su método de construcción
        PanelHistoria panelHistoriaLogica = new PanelHistoria(this.usuarioActual);
        return panelHistoriaLogica.crearPanelHistoria();
    }
    ...
    private JPanel crearPanelDatos() {
        ...
        ficha.setMaximumSize(new Dimension(800, 250));
    ...
    private JPanel crearPanelHorario() {
        ...
        btnPrint.addActionListener(e -> {
            ...
            try {
                ...
                t.print(JTable.PrintMode.FIT_WIDTH, new java.text.MessageFormat("Horario UNAL"),
